...
let
  nixifiedLockHash = "7ba833d7ed5962f631d3832c05cf774952db7c0b6e731047aef00a56b322ff2e";
...
if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  in
  {
    ...
    workspace = {
      hello-rust = rustPackages.unknown.hello-rust."0.1.0";
    };
    "unknown".hello-rust."0.1.0" = overridableMkRustCrate (profileName: rec {
      name = "hello-rust";
      version = "0.1.0";
      registry = "unknown";
