...
pub fn generate_traits(
    ...
    for declaration in &extraction_result.declarations {
        ...
        let get_name_method_name =
            Ident::new(&get_name_method_name_str, proc_macro2::Span::call_site());
        ...
        for dependency_name in all_dependencies {
            ...
            let get_dependency_method_name = Ident::new(
                &get_dependency_method_name_str,
                ...
                if let Fields::Named(fields) = &parsed_item_struct.fields {
                    for field in &fields.named {
                        if let Some(field_ident) = &field.ident {
                            ...
                            let method_name =
                                Ident::new(&method_name_str, proc_macro2::Span::call_site());
