...
pub use bag_of_words_visitor::{tokenize_ident_to_subwords, BagOfWordsVisitor};
pub use generate_prelude::generate_prelude;
pub use modify_crate_root::modify_crate_root;
pub use modify_file::modify_file;
pub use pipeline_traits::{AstStatistics, FunctionInfo, ImportInfo, VariableInfo};
pub use processor::process_crates;
pub use report::generate_report;
pub use split_expanded_lib::{
    Declaration, ErrorSample, FileMetadata as SplitExpandedFileMetadata, PublicSymbol, RustcInfo,
    SerializableDeclaration,
};
pub use symbol_map::SymbolMap;
pub use test_extractor::{
    collect_all_test_cases, generate_test_report_json,
    generate_test_verification_script_and_report, TestInfo,
};
...
pub use types::{
    CollectedAnalysisData, CollectedPreludeInfo, CollectedProjectInfo, FileProcessingResult,
    FileProcessingStatus, SplitExpandedBinInputs,
};

pub type PipelineConfig = pipeline_traits::Config;
pub use pipeline_traits::{
    BinsConfig, BuildConfig, ChangeIdConfig, Config, DistConfig, EnvConfig, InstallConfig,
    LlvmConfig, ModuleExportsConfig, NixConfig, RustConfig,
};
