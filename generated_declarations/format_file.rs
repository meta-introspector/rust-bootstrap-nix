# [allow (clippy :: too_many_arguments)] pub fn format_file (system : & str , flake_path_str : & str , nixpkgs_path : & str , rust_overlay_path : & str , rust_bootstrap_nix_path : & str , configuration_nix_path : & str , rust_src_flake_path : & str , rust_bootstrap_nix_flake_ref : & str , rust_src_flake_ref : & str , stage : & str , target : & str , rustc_path : & str , cargo_path : & str , rust_channel : & str , rust_download_rustc : bool , rust_parallel_compiler : bool , rust_llvm_tools : bool , rust_debuginfo_level : u8 , patch_binaries_for_nix : bool , vendor : bool , build_dir : & str , build_jobs : u32 , home_dir : & str , cargo_home_dir : & str , install_prefix : & str , install_sysconfdir : & str , dist_sign_folder : & str , dist_upload_addr : & str , llvm_download_ci_llvm : bool , llvm_ninja : bool , change_id : & str ,) -> String { let template_content = r#"# Generated by bootstrap-config-builder
#
# System: {system}
