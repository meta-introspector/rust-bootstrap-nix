{
  description = "Nix flake for Rust package: bootstrap-config-builder";
  ...
  outputs = { self, nixpkgs, rust-overlay, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        packages.bootstrap-config-builder = pkgs.rustPlatform.buildRustPackage {
          pname = "bootstrap-config-builder";
          version = "0.1.0";
          src = ./.;
