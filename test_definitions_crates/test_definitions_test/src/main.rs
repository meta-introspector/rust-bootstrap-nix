...
impl ShouldRun {
    pub fn suite_path(self, _path: &str) -> Self { self }
}

impl<'a> Builder<'a> {
    pub fn compiler(&self, _stage: u32, _target: TargetSelection) -> Compiler { Compiler }
    pub fn build_triple(&self) -> TargetSelection { TargetSelection }
...
impl Step for compiletest::Compiletest {
    ...
    fn should_run(run: ShouldRun) -> ShouldRun { run }
