{
  description = "Nix flake for Rust package: cargo-flake-generator";
  ...
  outputs = { self, nixpkgs, rust-overlay, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        packages.cargo-flake-generator = pkgs.rustPlatform.buildRustPackage {
          pname = "cargo-flake-generator";
          version = "0.1.0";
          src = ./.;
